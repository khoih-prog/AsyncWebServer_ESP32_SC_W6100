...
/*
  ...
  - publishes {Hello from MQTTClient_SSL on RP2040W} to the topic [ESP32_SC_Pub]
  - subscribes to the topic [ESP32_SC_Sub], printing out any messages
...
#define USING_THINGSTREAM_IO      false   //true
  ...
  String      topic       = "ESP32_SC_Pub";              // Topic to publish
  String      subTopic    = "ESP32_SC_Sub";              // Topic to subcribe to
