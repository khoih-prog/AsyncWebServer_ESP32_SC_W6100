/****************************************************************************************************************************
  AsyncWebServer_ESP32_SC_W6100.h - Dead simple Ethernet AsyncWebServer.
...
#ifndef _AsyncWebServer_ESP32_SC_W6100_H_
#define _AsyncWebServer_ESP32_SC_W6100_H_
...
/////////////////////////////////////////////////
  ...
  #define USING_CORE_ESP32_CORE_V200_PLUS      true
    ...
    #warning Using code for ESP32 core v2.0.0+ in AsyncWebServer_ESP32_SC_W6100.h
  #endif

  #define ASYNC_WEBSERVER_ESP32_SC_W6100_VERSION      "AsyncWebServer_ESP32_SC_W6100 v1.8.1 for core v2.0.0+"
#else

  #if (_ASYNC_WEBSERVER_LOGLEVEL_ > 3 )
    #warning Using code for ESP32 core v1.0.6- in AsyncWebServer_ESP32_SC_W6100.h
  #endif

  #define ASYNC_WEBSERVER_ESP32_SC_W6100_VERSION      "AsyncWebServer_ESP32_SC_W6100 v1.8.1 for core v1.0.6-"
#endif

#define ASYNC_WEBSERVER_ESP32_SC_W6100_VERSION_MAJOR     1
#define ASYNC_WEBSERVER_ESP32_SC_W6100_VERSION_MINOR     8
#define ASYNC_WEBSERVER_ESP32_SC_W6100_VERSION_PATCH     1

#define ASYNC_WEBSERVER_ESP32_SC_W6100_VERSION_INT       1008001

/////////////////////////////////////////////////

#ifndef ESP32_W6100_AWS_UNUSED
  #define ESP32_W6100_AWS_UNUSED(x)       (void)(x)
#endif
...
#endif /* _AsyncWebServer_ESP32_SC_W6100_H_ */
